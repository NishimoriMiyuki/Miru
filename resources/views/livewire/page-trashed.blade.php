...
<div class="w-1/2 h-full space-y-4 pt-4 flex flex-col container">
    ...
    @if($isShow)
    <div style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0,0,0,0.5); display: flex; justify-content: center; align-items: center; z-index: 9999;" wire:click.self="$set('isShow', false)">
        <div style="background-color: white; padding: 20px; border-radius: 8px;">
            <div class="flex flex-col" style="width: 1000px; height: 800px;">
                <input type="text" name="title" placeholder="タイトルを入力" class="border-transparent focus:border-transparent focus:ring-0 focus:outline-none text-3xl font-semibold font-bold pr-10" value="{{ $selectPage->title }}" readonly>
